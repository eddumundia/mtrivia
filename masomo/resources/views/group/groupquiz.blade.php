...
<div class="col-lg-8">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
    <p>{!!ucfirst(trans($question->question))!!}</p>
        ...
        <div class="row">
            ...
            <a href="{{ url('/group/') }}/{{$question->id}}/proceedgroup/{{$value->id}}/{{$random_id}}"><b><div class="answerholder col-md-<?php echo $bootstrapColWidth; ?>">
