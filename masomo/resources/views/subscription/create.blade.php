...
@section('content')
<?php 
include(app_path(). "/Libraries/OAuth.php");
//pesapal params
$token = $params = NULL;
...
*/
$consumer_key="KOHfvKRw/C6kQ6vtauVUq7MUwdbucJyQ";//Register a merchant account on
                   //demo.pesapal.com and use the merchant key for testing.
                   //When you are ready to go live make sure you change the key to the live account
                   //registered on www.pesapal.com!
$consumer_secret="bzVEg8pbSq3KYqEfuvKaAt1PVzo=";// Use the secret from your test
...
$desc = $data['desc'];
$type = $data['type']; //default value = MERCHANT
...
$callback_url = 'http://localhost/mtrivia/index.php/subscription/storage'; //redirect url, the page that will handle the response from pesapal.
