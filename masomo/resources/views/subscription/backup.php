 <?php 
            ...
            $iframelink = 'http://demo.pesapal.com/api/PostPesapalDirectOrderV4';//change to      
             ...
             //get form details
            $amount = number_format((int)$data->amount, 2, '.', '');//format amount to 2 decimal places
            ...
            $callback_url = 'https://gosavana.com/s8/thanks.php'; //redirect url, the page that will handle the response from pesapal.
