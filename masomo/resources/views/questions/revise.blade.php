                ...
                <div class="col-lg-10">
                    <div class="row">
                       ...
                       <hr>
                        ...
                        <div class="pull-left">
                            <div class="float-right"><a href="{{ url('/question/') }}/{{$question->id}}/prevrevise/{{$random_id}}" class="btn btn-primary"><span class="glyphicon glyphicon-chevron-left"></span>Prev</a></div>
                        </div>
                        <div class="pull-right">
                            <div class="float-right"><a href="{{ url('/question/') }}/{{$question->id}}/nextrevise/{{$random_id}}" class="btn btn-primary">Next<span class="glyphicon glyphicon-chevron-right"></span></a></div>
                        </div>
                    </div>
                            </div>
