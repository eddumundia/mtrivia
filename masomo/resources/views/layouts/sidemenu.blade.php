<div class="col-lg-2 col-md-2 col-sm-2">
    <ul class="list-group">
        <?php if(\Auth::user()->role_id == 3  || \Auth::user()->role_id == 4 ){?> <!-- Data entry clerk and teachers-->
...
<!--            <li class="list-group-item"><a href="{!!url('payment')!!}/{{\Auth::user()->id}}"><i class="fa fa-money" aria-hidden="true"></i> My balance <i class="glyphicon glyphicon-chevron-right"></i></a></li>-->
           <li class="list-group-item"><a href="{!!url('group/show')!!}"><i class="fa fa-percent" aria-hidden="true"></i> Groups <i class="glyphicon glyphicon-chevron-right"></i></a></li>
